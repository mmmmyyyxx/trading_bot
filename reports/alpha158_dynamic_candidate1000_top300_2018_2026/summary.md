...
Run: `d288b87ec47043d3afdf259fe4776f0b`  
...
| Excess annualized return with cost | 30.79% |
| Excess information ratio with cost | 2.383 |
| Excess max drawdown with cost | -11.34% |
| Excess annualized return without cost | 36.11% |
| Excess information ratio without cost | 2.794 |
| Excess max drawdown without cost | -10.87% |
| Account total return | 138.96% |
| Benchmark total return | 54.44% |
| Average daily turnover | 0.400120 |
| Total cost sum | 2063759376.43 |
...
| position_weighted_unknown | 0.21% |
